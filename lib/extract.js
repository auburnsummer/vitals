...
const extractors = {
  ...
  ipfsHash:       require('./extractors/uploadToIPFS.js'),
...
const profiles = {
  ...
  test: () => _.difference(_.keys(extractors), ['previewImageIpfsHash', 'iconIpfsHash', 'ipfsHash']),
  noupload: () => _.difference(_.keys(extractors), ['ipfsHash']),
};
